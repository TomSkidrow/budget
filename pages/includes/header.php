    ...
    <div class="sidemenu-container navbar-collapse collapse fixed-menu">
        <div id="remove-scroll" class="left-sidemenu">
            <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="nav-item start <?php if ($name == 'dashboard' || $name == 'dashboard1' || $name == 'dashboard2') { echo 'active open'; } ?>">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  <?php echo $name == 'dashboard' ? 'active': '' ?> ">
                            <a href="../dashboard" class="nav-link ">
                                <span class="title">กฟส.ขนาด L,M</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo $name == 'dashboard1' ? 'active': '' ?>">
                            <a href="../dashboard1" class="nav-link ">
                                <span class="title">กฟส.ขนาด S</span>
                                <span class="selected"></span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo $name == 'dashboard2' ? 'active': '' ?>">
                            <a href="../dashboard2" class="nav-link ">
                                <span class="title">กฟส.ขนาด XS</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item <?php echo $name == 'data1' ? 'active': '' ?>">
                    <a href="../data1" class="nav-link nav-toggle"> <i data-feather="grid"></i>
                        <span class="title">ข้อมูลตามรหัสบัญชี</span>
                    </a>
                </li>

                <li class="nav-item start <?php if ($name == 'benchmarking' || $name == 'benchmarking1' || $name == 'benchmarking2') { echo 'active open'; } ?>">
                    <a href="#" class="nav-link nav-toggle">
                        <i data-feather="copy"></i>
                        <span class="title">Benchmarking</span>
                        <span class="selected"></span>
                        <span class="arrow open"></span>
                    </a>
                    <ul class="sub-menu">
                        <li class="nav-item  <?php echo $name == 'benchmarking' ? 'active': '' ?> ">
                            <a href="../benchmarking" class="nav-link ">
                                <span class="title">กฟส.ขนาด L,M</span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo $name == 'benchmarking1' ? 'active': '' ?>">
                            <a href="../benchmarking1" class="nav-link ">
                                <span class="title">กฟส.ขนาด S</span>
                                <span class="selected"></span>
                            </a>
                        </li>
                        <li class="nav-item <?php echo $name == 'benchmarking2' ? 'active': '' ?>">
                            <a href="../benchmarking2" class="nav-link ">
                                <span class="title">กฟส.ขนาด XS</span>
                            </a>
                        </li>
                    </ul>
