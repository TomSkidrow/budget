                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="example4">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">ปริมาตรการใช้<br>งบประมาณทั้งหมด</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
...
<!--
                                                <td><mark><?php //echo number_format($row['sum_budget_12m'],2); ?></mark></td>
                                                <td><mark><?php //echo number_format($row['sum_budget_total'],2); ?></mark></td>
-->
                                                <!--                                                <td><mark><?php //echo number_format($row['sum_pay_savings'],2); ?></mark></td>-->
                                                <!--                                                <td><mark><?php //echo number_format($row3['sum_except'],2); ?></mark></td>-->
<!--
                                                <td><mark><?php //echo number_format($row['sum_criteria_expenses'],2); ?></mark></td>
                                                <td><mark><?php //echo number_format($row['balance'],2); ?></mark></td>
                                                <td><mark><?php //echo number_format($row['percent_savings'],2); ?></mark></td>
                                                <td><mark><?php //echo number_format($row['percent_budget'],2); ?></mark></td>
-->
<!--                                                <td colspan="2"></td>-->
                                            </tr>
                                            <?php //} ?>
